# Generated by Django 5.2.5 on 2026-01-04 04:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('register', '0002_alter_historicalregister_sex_alter_register_sex'),
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='n_municipal',
            field=models.CharField(blank=True, max_length=14, null=True, verbose_name='Inscrição Municipal'),
        ),
        migrations.AlterField(
            model_name='historicalregister',
            name='n_state',
        ...
        migrations.AlterField(
            model_name='historicalregister',
            name='rg_expedition',
            field=models.DateField(blank=True, null=True, verbose_name='Expedição'),
        ),
        migrations.AlterField(
            model_name='historicalregister',
            name='spouse_status',
            field=models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Casado'), (2, 'Divorciado'), (3, 'Solteiro'), (4, 'União Estável'), (5, 'Viúvo')], null=True, verbose_name='Estado Civil'),
        ),
        migrations.AlterField(
            model_name='historicalregister',
            name='type',
            field=models.PositiveSmallIntegerField(choices=[(0, 'Pessoa Física'), (1, 'Pessoa Jurídica')], verbose_name='Tipo'),
        ),
        migrations.AlterField(
            model_name='register',
            name='n_municipal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(choices=[(0, 'Pessoa Física'), (1, 'Pessoa Jurídica')], verbose_name='Tipo')),
                ...
                ('n_state', models.CharField(blank=True, max_length=14, null=True, verbose_name='Inscrição Estadual')),
                ('n_municipal', models.CharField(blank=True, max_length=14, null=True, verbose_name='Inscrição Municipal')),
                ...
                ('rg_expedition', models.DateField(blank=True, null=True, verbose_name='Expedição')),
                ...
                ('sex', models.CharField(blank=True, choices=[('M', 'Homem cisgênero'), ('MT', 'Homem transgênero'), ('F', 'Mulher cisgênero'), ('FT', 'Mulher transgênero'), ('NF', 'Pessoa não binária do sexo feminino'), ('NM', 'Pessoa não binária do sexo masculino'), ('-', 'Não informado')], max_length=2, null=True, verbose_name='Sexo')),
                ('spouse_status', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Casado'), (2, 'Divorciado'), (3, 'Solteiro'), (4, 'União Estável'), (5, 'Viúvo')], null=True, verbose_name='Estado Civil')),

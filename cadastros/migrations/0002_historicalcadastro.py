    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cadastrado_em', models.DateTimeField(blank=True, editable=False, verbose_name='Data de Cadastro')),
                ...
                ('cadastrado_por', models.ForeignKey(blank=True, db_constraint=False, default=1, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Cadastrado por')),
